...
class Nanse < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/nanse-ai/nanse/releases/download/cli-v0.0.0-test/nanse-aarch64-apple-darwin"
      sha256 "b1715fbdb1c50e6143253f71bc7516f6a336aabde60f20a28fce279fa0be4522"
    else
      url "https://github.com/nanse-ai/nanse/releases/download/cli-v0.0.0-test/nanse-x86_64-apple-darwin"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/nanse-ai/nanse/releases/download/cli-v0.0.0-test/nanse-x86_64-unknown-linux-gnu"
